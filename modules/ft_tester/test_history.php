...
$whereConditions = ["tr.tester_id = ? AND tr.tester_role = 'ft_tester'"];
$params = [$userId];
...
$historyQuery = "
    SELECT tr.*, pp.page_name, p.title as project_title, p.po_number,
           te.name as environment_name, te.browser
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="fas fa-history text-success"></i> FT Testing History</h2>
                <div>
