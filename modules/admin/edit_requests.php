                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form id="requestActionForm_<?php echo $req['id']; ?>" method="POST" class="d-inline">
                                            ...
                                            <button type="button" class="btn btn-success btn-sm" onclick="document.getElementById('requestAction_<?php echo $req['id']; ?>').value='approved'; confirmForm('requestActionForm_<?php echo $req['id']; ?>', 'Approve this edit request?')">
                                                <i class="fas fa-check"></i> Approve
                                            </button>
                                            <button type="button" class="btn btn-danger btn-sm" onclick="document.getElementById('requestAction_<?php echo $req['id']; ?>').value='rejected'; confirmForm('requestActionForm_<?php echo $req['id']; ?>', 'Reject this edit request?')">
